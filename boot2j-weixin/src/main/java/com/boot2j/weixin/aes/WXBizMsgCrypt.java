...
{
	private Logger logger = Logger.getLogger(WXBizMsgCrypt.class);
	...
	String decrypt(String text) throws AesException
	{
		...
		logger.info("from_appid:" + from_appid);
		// appid不相同的情况
	 ...
	 * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
	 */
	public String decryptMsgW(String msgSignature, String timeStamp, String nonce, String encrypt) throws AesException
	{
