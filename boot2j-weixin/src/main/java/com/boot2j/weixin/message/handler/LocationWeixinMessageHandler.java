 ...
 * @since 1.0
 */
@WeixinMessageHandler(type = MessageType.LOCATION)
public class LocationWeixinMessageHandler extends AbstractWeixinMessageHandler {

	public LocationWeixinMessageHandler(LocationWeixinMessage message) {
		super(message);
	}
